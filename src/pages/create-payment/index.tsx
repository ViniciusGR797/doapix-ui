...
export default function CreateDonation() {
    ...
    const name = "World Wide Fund for Nature World Wide Fund for Nature"
                    ...
                    <div className={styles.square}>
                        ...
                        <div className={styles.body}>
                            ...
                            <div className={styles.inputCenter}>
                                <Input className={styles.input} placeholder="Apelido" type="text" value={alias} onChange={(e) => setAlias(e.target.value)} />
                                <Input className={styles.input} placeholder="Email (não será compartilhado)" type="text" value={email} onChange={(e) => setEmail(e.target.value)} />
                                <Input className={styles.input} placeholder="Valor" type="text" value={amount} onChange={(e) => setAmount(e.target.value)} />
                            </div>
